...
zfs_pool_name="rpool"
zfs_pool_disks=("/dev/nvme0n1") # Note: using /dev/disk/by-id is also preferable.
...
nix_top_level_configuration="hosts/tc01" # Your top-level nix file to be bootstrapped
